        ...
        if (robot.borderCheck() == 0) {
         ...
         switch(waitKey(1)) {
                case (int('l')):
                    ...
                    model.setVelocity(model.accessvX(), model.accessvY(), model.accessvTetha() + rotateSpeedValue);
                break;
                case (int('j')):
                    robot.storePosition(robot.accessX(), robot.accessY(), robot.accessTheta(), robot.accessVX(), robot.accessVY(), robot.accessVTheta());
                    status.resetError();
                ...
                case (int('i')):
                    robot.storePosition(robot.accessX(), robot.accessY(), robot.accessTheta(), robot.accessVX(), robot.accessVY(), robot.accessVTheta());
                    status.resetError();
                    model.setVelocity(model.accessvX() + moveSpeedValue, model.accessvY(), model.accessvTetha());
                ...
                case (int(';')):
                    ...
                    model.setVelocity(model.accessvX(), model.accessvY() + moveSpeedValue, model.accessvTetha());
                break;
                case (int(',')):
                    robot.storePosition(robot.accessX(), robot.accessY(), robot.accessTheta(), robot.accessVX(), robot.accessVY(), robot.accessVTheta());
                    status.resetError();
                ...
                case (int('h')):
                    ...
                    status.resetError();
                    robot.setVelocity(robot.accessVX(), robot.accessVY() - moveSpeedValue, robot.accessVTheta());
                    model.setVelocity(model.accessvX(), robot.accessVY() - moveSpeedValue, model.accessvTetha());
                break;
                //-- [j] --> Reset Key
                case (int('k')):
                    robot.setVelocity(0, 0, 0);
...
void World::createModel(){
    ...
    //--| World |--
    //-------------
    double agentCenterX = model.accessX();
    double agentCenterY = model.accessY();
        ...
        if (mouseFlag == 1){
            ...
            switch(event){
                ...
                case EVENT_LBUTTONUP:
                    clickedColorValue = 0;
                    mouseFlag = 1;
                    robot.setVelocity( model.accessvX(),model.accessvY(),model.accessvTetha());
                break;
